...
This CloudFormation template deploys ALTCHA Sentinel as an ECS Fargate service with an Application Load Balancer (ALB) on AWS.
...
|-----------|---------|-------------|
| `ImageURI` | `ghcr.io/altcha-org/sentinel:<version>` | Container image URI |
